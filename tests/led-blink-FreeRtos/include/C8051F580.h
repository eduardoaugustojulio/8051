...
SFR (PCA1CPL7, 0xE9);                  // PCA1 Capture 7 Low
SFR (PCA0CPH1, 0xEA);                  // PCA0 Capture 1 High
SFR (PCA1CPH7, 0xEA);                  // PCA1 Capture 7 High
SFR (PCA0CPL2, 0xEB);                  // PCA0 Capture 2 Low
SFR (PCA1CPL8, 0xEB);                  // PCA1 Capture 8 Low
SFR (PCA0CPH2, 0xEC);                  // PCA0 Capture 2 High
SFR (PCA1CPH8, 0xEC);                  // PCA1 Capture 8 High
SFR (PCA0CPL3, 0xED);                  // PCA0 Capture 3 Low
SFR (PCA1CPL9, 0xED);                  // PCA1 Capture 9 Low
SFR (PCA0CPH3, 0xEE);                  // PCA0 Capture 3 High
SFR (PCA1CPH9, 0xEE);                  // PCA1 Capture 9 High
